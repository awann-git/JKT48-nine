              ...
              {cell ? (
                <>
                  <div className={`absolute inset-0 bg-gradient-to-br ${GRADIENTS[i]} flex items-center justify-center`}>
                    <img src={`public/${cell.picture}`} className="w-full h-full rounded-l object-cover" />
                  </div>
            ...
            <div className="flex flex-col gap-1">
              {filteredCategories.map((item) => {
                ...
                return (
                  ...
                  >
                    <img src={`public/${item.picture}?raw=true`} className="w-15 h-20 rounded-l object-cover" />
